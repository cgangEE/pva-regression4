...
class flickr(imdb):
    def __init__(self, image_set, year):
        imdb.__init__(self, 'flickr_' + image_set)
        self._image_set = image_set
        self._data_path = os.path.join(cfg.DATA_DIR, 'flickr')
    ...
    def _get_annotation(self, index):
        tattoos = self._indexToAnnotation[index]

        num_objs = len(tattoos)
