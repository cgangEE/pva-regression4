...
class cox_reid(imdb):
    def __init__(self, image_set, year):
        imdb.__init__(self, 'cox_reid_' + image_set)
        self._image_set = image_set
        self._data_path = os.path.join(cfg.DATA_DIR, 'cox_reid')

        self._classes = ('background', 'pedestrain', 'head', 'head-shoulder', 'upperbody')
...
if __name__ == '__main__':
    my_cox_reid = cox_reid('train', '2011');
